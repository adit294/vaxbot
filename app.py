...
# CITIES =["BOM","BLR","AMD","KOL","CHN"]
# CITY_NAMES = {"BOM": "Mumbai","BLR":"Bangalore","AMD":"Ahmedabad","KOL": "Kolkata","CHN":"Chennai","CDL":"Central Delhi","EDL":"East Delhi","NEW":"New delhi","NDL":"North delhi","NED":"NE delhi","NWD":"NW Delhi","SHD":"Shahdara","SDL":"South Delhi","SED":"SE Delhi","SWD":"SW delhi","WDL":"West delhi"}
# DISTRICT_IDS = {"BOM": "395","BLR": "265","AMD":"154","KOL":"725","CHN":"571","CDL":"141","EDL":"145","NEW":"140","NDL":"146","NED":"147","NWD":"143","SHD":"148","SDL":"149","SED":"144","SWD":"150","WDL":"142"}
# RAIN_NAMES = {"BOM": "Mumbai","BLR":"Bangalore","AMD":"Ahmedabad","KOL": "Kolkata","CHN":"Chennai","CDL":"Delhi","EDL":"Delhi","NEW":"delhi","NDL":"delhi","NED":"delhi","NWD":"Delhi","SHD":"Delhi","SDL":"Delhi","SED":"Delhi","SWD":"delhi","WDL":"delhi"}
...
def runner():
	...
	for city in CITIES:
		...
		updated_avail, covi_dose1_avail_18 , covi_dose2_avail_18,covax_dose1_avail_18, covax_dose2_avail_18,covi_dose1_avail_45,covi_dose2_avail_45,covax_dose1_avail_45,covax_dose2_avail_45, avail_18, avail_45, updated_sessions = compare_availability_to_prev(parsed_info, SIMPLIFIED_INFO_FILENAME.format(city))
		if updated_avail > 0:
			#send tweet here
			tweet_file = open(POSTED_TWEET_LOGFILE.format(city), "a")
			city_name = CITY_NAMES[city]
			rain_name = RAIN_NAMES[city]
			tweet = f'{city_name} has at least {updated_avail} new slots available between {new_format} & {new_format3}.\n\nCovishield:\nDose1- 18+/45+:{covi_dose1_avail_18}/{covi_dose1_avail_45}\nDose2- 18+/45+:{covi_dose2_avail_18}/{covi_dose2_avail_45}\n\nCovaxin:\nDose1- 18+/45+:{covax_dose1_avail_18}/{covax_dose1_avail_45}\nDose2- 18+/45+:{covax_dose2_avail_18}/{covax_dose2_avail_45}\n\nBook one now at cowin.gov.in #vaccine #cowin #covid #{rain_name}'
